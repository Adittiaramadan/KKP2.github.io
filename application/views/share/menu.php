...
<header class="main-header">
    <!-- logo-->
    <a href="<?php echo site_url(); ?>" class="logo-holder" style="float: left;height: 80%;position: relative;top: 10px;"><img src="<?php echo site_url(); ?>assets/Gambar/polri.png" alt=""></a>
    <!-- logo end-->
