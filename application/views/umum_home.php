				...
				<section class="hero-section"   data-scrollax-parent="true">
					<div class="bg-tabs-wrap">
						<div class="bg-parallax-wrap" data-scrollax="properties: { translateY: '200px' }">
							 ...
							 <div class="bg bg_tabs"  data-bg="<?php echo site_url(); ?>assets/Gambar/polisi.jpeg"></div> -->
												...
												<form action="<?php echo site_url(); ?>pengaduan" method="post" enctype="multipart/form-data">
													<div class="row">
														<div class="col-sm-6">
															...
															<input required type="text" name="nik" placeholder="NIK" value="" minlength="16" maxlength="16">
														</div>
														<div class="col-sm-6">
														  ...
														  <div class="col-sm-6"> 
															 <label style="padding: 10px;">Email<i class="far fa-envelope" style="top: 50px;"></i>  </label>
														...
														<div class="col-sm-6">
															...
															<input required type="text"  name="no_telepon" placeholder="Masukan Nomor Telepon Anda" value="">
														</div>
														<div class="col-sm-6">
															<label style="padding: 10px;">Alamat<i class="far fa-envelope" style="top: 50px;"></i>  </label>
															<input required type="text"  name="alamat" placeholder="Alamat Lengkap" value="">
														</div>
														<div class="col-sm-6">
															<label style="padding: 10px;">Pekerjaan<i class="far fa-user" style="top: 50px;"></i>  </label>
															<input required type="text" name="pekerjaan" placeholder="Pekerjaan" value="">
														</div>
				...
				<section>
					<div class="container big-container">
						<div class="section-title">
							<h2><span>Sosial Media Polres Tangerang Kota </span></h2>
							<div class="section-subtitle">Info</div>
							<span class="section-separator"></span>

						</div>
						<table class="col-md-6 col-lg-12">
							<tr>
								<td>
									<a href="https://instagram.com/polrestrotangerangkota?utm_medium=copy_link"><img src="<?php echo site_url(); ?>assets/Gambar/instagram.png"width="150" height="150"></a>
								</td>
								<td>
									<a href="https://mobile.twitter.com/restrotangkot?s=08"><img src="<?php echo site_url(); ?>assets/Gambar/twitter.png"width="150" height="150"></a>
								</td>
								<td>
									<a href="https://www.facebook.com/restrotangkot/"><img src="<?php echo site_url(); ?>assets/Gambar/facebook.png"width="150" height="150"></a>
								</td>
							</tr>
						</table>
									...
									<ul class="no-list-style">
										<li>
											<div class="process-item">
												...
												<p>Anda Dapat Melaporkan Masalah Yang Terjadi Di Lingkungan Kota Tangerang</p>
											</div>
